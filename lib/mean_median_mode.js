...
module.exports = mmm;
  ...
  // this.Mean = function(testArray){
  //   meanModule(testArray, function(mean) {
  //     return mean;
  //     });
  // };

  // this.Median = function(testArray) {
  //   medianModule(testArray, function(median) {
  //     return median;
  //   });
  // };

  // this.Mode = function(testArray) {
  //   modeModule(testArray, function(mode) {
  //     return mode;
  //   });
  // };
...
//Alnitak on Stack Overflow, for the inspiration to the mode solution:
